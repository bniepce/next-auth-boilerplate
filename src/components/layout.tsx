            ...
            <aside className="w-64 h-full" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <a onClick={() => signOut()} href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
